...
```
docker build --pull -t bun-redmine:0.3.1rc1 .

docker build --pull -t bun-redmine:0.3.1rc1 . --no-cache --progress=plain 

docker run -d -p 3000:3000 --env-file .\.env --name bun-redmine bun-redmine:0.3.1rc1

docker tag bun-redmine:0.3.1rc1 pi1ngkunga/bun-redmine:0.3.1rc1
docker push pingkunga/bun-redmine:0.3.1rc1
```
