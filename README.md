...
```
docker build --pull -t bun-redmine:0.3.2rc7 .

docker build --pull -t bun-redmine:0.3.2rc7 . --no-cache --progress=plain 

docker run -d -p 3000:3000 --env-file .\.env --name bun-redmine bun-redmine:0.3.2rc7

docker tag bun-redmine:0.3.2rc7 pingkunga/bun-redmine:0.3.2rc7
docker push pingkunga/bun-redmine:0.3.2rc7
```
